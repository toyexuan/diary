export const enum PageDefaultBackgroundImageEnum {
  home = './assets/imgs/0.jpg',
...
export const HisAvatar = './assets/imgs/him.jpg';
export const HerAvatar = './assets/imgs/her.jpg';
